            ...
            <div class="col-md-8">
                <div class="card" style="background: #c9eb89b0;">
                    <div class="card-header text-center pt-4" style="background-color: #e1ed72;"><h3
                            style="font-weight: bold;">會員註冊</h3></div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right"><h5
                                        style="font-weight: bold;">姓名
                                    </h5></label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right"><h5
                                        style="font-weight: bold;">確認密碼</h5></label>
